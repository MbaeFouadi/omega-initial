...
// pour moheli
    ...
    //IFERE
        //formation des profs
            //choix1
            $i1m="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='3'  and candidats.choix1= 'REm' AND (id_type='1' OR id_type='41' OR id_type='51')";
            $RE1m = mysqli_query($link,$i1m);
            $roumanie1m = mysqli_num_rows($RE1m); 

            //choix2
                $i2m="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='3'  and candidats.choix2= 'REm' AND (id_type='1' OR id_type='41' OR id_type='51')";
                $RE2m = mysqli_query($link,$i2m);
                $roumanie2m = mysqli_num_rows($RE2m); 

            //choix3
                $i3m="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='3'  and candidats.choix3= 'REm' AND (id_type='1' OR id_type='41' OR id_type='51')";
                $RE3m = mysqli_query($link,$i3m);
                $roumanie3m = mysqli_num_rows($RE3m); 

            //formation des profs Moroni ->  Fomboni 

            $rahn = mysqli_query($link,"SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1' and  (candidats.choix1= 'REm' or candidats.choix2='REm' or candidats.choix3='REm') AND (id_type='1' OR id_type='41' OR id_type='51')");
            $rahN= mysqli_num_rows($rahn);

            //formation des profs   Patsy -> Fomboni 

            $raha = mysqli_query($link,"SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='2' and (choix1= 'REm' or choix2='REm' or choix3='REm') AND (id_type='1' OR id_type='41' OR id_type='51')");
...
// pour anjouan
    ...
    //formation des profs
        //choix1
        $i1a="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='2'  and candidats.choix1= 'REp' AND (id_type='1' OR id_type='41' OR id_type='51')";
        $RE1a = mysqli_query($link,$i1a);
        $roumanie1a = mysqli_num_rows($RE1a); 

        //choix2
            $i2a="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='2'  and candidats.choix2= 'REp' AND (id_type='1' OR id_type='41' OR id_type='51')";
            $RE2a = mysqli_query($link,$i2a);
            $roumanie2a = mysqli_num_rows($RE2a); 

        //choix3
            $i3a="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='2'  and candidats.choix3= 'REp' AND (id_type='1' OR id_type='41' OR id_type='51')";
            ...
            $nourn = mysqli_query($link,"SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and  (candidats.choix1= 'REp' or candidats.choix2='REp' or candidats.choix3='REp') AND (id_type='1' OR id_type='41' OR id_type='51')");
            $nourN= mysqli_num_rows($nourn);

            //formation des profs  Fomboni  -> Patsy

            $nourm = mysqli_query($link,"SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='3'  and (candidats.choix1= 'REp' or candidats.choix2='REp' or candidats.choix3='REp') AND (id_type='1' OR id_type='41' OR id_type='51')");
...
// pour ngazidja
    ...
    //Geni info
        //choix1
        $d1n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix1= 'GI' AND (id_type='1' OR id_type='41' OR id_type='51')";
        $GI1n = mysqli_query($link,$d1n);
        $ghana1n = mysqli_num_rows($GI1n); 

        //choix2
            $d2n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix2= 'GI' AND (id_type='1' OR id_type='41' OR id_type='51')";
            $GI2n = mysqli_query($link,$d2n);
            $ghana2n = mysqli_num_rows($GI2n); 

        //choix3
            $d3n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix3= 'GI' AND (id_type='1' OR id_type='41' OR id_type='51')";
    ...
    //statistique
        //choix1
        $f1n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix1= 'STQ' AND (id_type='1' OR id_type='41' OR id_type='51')";
        $STQ1n = mysqli_query($link,$f1n);
        $syrie1n = mysqli_num_rows($STQ1n); 

        //choix2
            $f2n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix2= 'STQ' AND (id_type='1' OR id_type='41' OR id_type='51')";
            $STQ2n = mysqli_query($link,$f2n);
            $syrie2n = mysqli_num_rows($STQ2n); 

        //choix3
            $f3n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix3= 'STQ' AND (id_type='1' OR id_type='41' OR id_type='51')";
    ...
    //soins infirmiers
        //choix1
        $g1n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix1= 'IE'  AND (id_type='1' OR id_type='41' OR id_type='51')";
        $IE1n = mysqli_query($link,$g1n);
        $italie1n = mysqli_num_rows($IE1n); 

        //choix2
            $g2n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix2= 'IE'  AND (id_type='1' OR id_type='41' OR id_type='51')";
            $IE2n = mysqli_query($link,$g2n);
            $italie2n = mysqli_num_rows($IE2n); 

        //choix3
            $g3n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix3= 'IE'  AND (id_type='1' OR id_type='41' OR id_type='51')";
    ...
    //soins obstetricaux
        //choix1
        $h1n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix1= 'SF' AND (id_type='1' OR id_type='41' OR id_type='51')";
        $SF1n = mysqli_query($link,$h1n);
        $soudan1n = mysqli_num_rows($SF1n); 

        //choix2
            $h2n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix2= 'SF' AND (id_type='1' OR id_type='41' OR id_type='51')";
            $SF2n = mysqli_query($link,$h2n);
            $soudan2n = mysqli_num_rows($SF2n); 

        //choix3
            $h3n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix3= 'SF' AND (id_type='1' OR id_type='41' OR id_type='51')";
    ...
    //formation des profs
        //choix1
        $i1n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix1= 'RE' AND (id_type='1' OR id_type='41' OR id_type='51')";
        $RE1n = mysqli_query($link,$i1n);
        $roumanie1n = mysqli_num_rows($RE1n); 

        //choix2
            $i2n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix2= 'RE' AND (id_type='1' OR id_type='41' OR id_type='51')";
            $RE2n = mysqli_query($link,$i2n);
            $roumanie2n = mysqli_num_rows($RE2n); 

        //choix3
            $i3n="SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='1'  and candidats.choix3= 'RE' AND (id_type='1' OR id_type='41' OR id_type='51')";
        ...
        $amnim = mysqli_query($link,"SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='3' and (candidats.choix1= 'RE' or candidats.choix2='RE' or candidats.choix3='RE') AND (id_type='1' OR id_type='41' OR id_type='51')");
        $amniM = mysqli_num_rows($amnim);

        //formation des profs Patsy -> Moroni

        $amnia = mysqli_query($link,"SELECT * FROM users,candidats WHERE users.login=candidats.traitant_recu and  users.id_ile='2'
         and (candidats.choix1= 'RE' or candidats.choix2='RE' or candidats.choix3='RE') AND (id_type='1' OR id_type='41' OR id_type='51')");
