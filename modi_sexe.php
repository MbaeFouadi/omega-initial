...
// $sq= mysqli_query($link,"SELECT * FROM etudiant where sexe!='F' AND sexe!='M' AND sexe IS NULL");
$sq= mysqli_query($link,"SELECT * FROM etudiant where sexe IS NULL");


if(isset($_GET['f'])){
    $sq= mysqli_query($link,"UPDATE etudiant set sexe='F' WHERE mat_etud='".$_GET['f']."'");
    header("location:modi_sexe.php");
}

if(isset($_GET['m'])){
    $sq= mysqli_query($link,"UPDATE etudiant set sexe='M' WHERE mat_etud='".$_GET['m']."'");
    header("location:modi_sexe.php");
                                ...
                                while($dat=mysqli_fetch_array($sq)){
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?=  utf8_encode($dat['date_naiss'])?></td>
                                            <td><?=  utf8_encode(strtoupper($dat['lieu_naiss']))?></td>
                                            <td><a href="modi_sexe.php?f=<?=$dat['mat_etud']?>">F</a>-<a href="modi_sexe.php?m=<?=$dat['mat_etud']?>">M</a></td>
