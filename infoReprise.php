...
$aa = $dd."-".$d;
  ...
  if(mysqli_num_rows($bete)>0)
    ...
    header('location: recu.php');
        ...
        //$req=mysqli_query($link,"INSERT INTO candidats (nin,nom,date_naiss,lieu_naiss,prenom,datePrescript,id_type,traitant_recu,statut,tel_mobile,sexe) values ('$n','$nom','$naiss','$lieu_naiss','$prenom','$dateJ','4','".$_SESSION['login']."','1','$telm','$sexe')");
...
<html lang="en">
    ...
    <main class="main-content">
        ...
        <div class="col-12">
            ...
            <form action="infoReprise.php" method="POST">
