...
$req = mysqli_query($link,"SELECT quitus.reference as reference,etudiant.NIN as nin ,nom,prenom FROM quitus RIGHT JOIN holo on holo.reference=holo_candidat.references RIGHT JOIN candidats on candidats.reference_id=holo.id WHERE holo_candidat.references IS NULL order by candidats.nom DESC");
