...
$inscrip=mysqli_query($link,"SELECT * FROM  inscription WHERE Annee='$an_univ'");
$inscripS=mysqli_num_rows($inscrip);
...
$sqNi=mysqli_query($link,"SELECT * FROM  users,post_inscription WHERE users.login=post_inscription.traitant_fiche and users.id_ile='1' and Annee='$an_univ' ");
                ...
                <div class="mini-card linear-card">
                   ...
                   $dat= mysqli_fetch_array($reque)?>
                    <div class="caption-card">
                        ...
                        <span class="card-val-text"><?php echo $inscripS?></span>
