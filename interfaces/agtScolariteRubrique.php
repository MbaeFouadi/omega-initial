...
<li><a href="num_recu.php"><i class="icon-pencil"></i> &nbsp; <span class="nav-item-text">Insertion des choix</a></li>
...
<li>
    <a data-toggle="collapse" href="#collapseMenu1" role="button" aria-expanded="false" aria-controls="collapseMenu1"><i class="icon-magnifier"></i> &nbsp; <span class="nav-item-text">Rechercher ...</span></a>
    <ul class="menu-dd collapse" id="collapseMenu1">
        <!--<li><a href="recherche_etudiant.php"><i class=""></i> &nbsp; Rechercher un étudiant</a></li>
        <li><a href="recherche_fiche.php"><i class=""></i> &nbsp; Rechercher une fiche</a></li>-->
        <!-- <li><a href="recherche_aut.php">&nbsp; Autorisation de paie</a></li> -->
        <li><a href="info.php"> &nbsp; Rechercher un dossier</a></li>
        <li><a href="recherche_fili.php"> &nbsp; Choix de filières </a></li>
