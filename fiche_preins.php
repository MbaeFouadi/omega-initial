        ...
        <h5 align="left" style="margin-top:-100px;margin-bottom:130px;margin-left:-60px;color:#00b185;"> Fin de préinscription : <?php echo $dat['date_fin'];?></h5>
                ...
                <div id='sectionAimprimer'>
                    <div class="container">
                        ...
                        <h6 style="margin-top:-25px;margin-bottom:-25px">B:&nbsp;<u>ETUDES SECONDAIRES ET UNIVERSITAIRES</u></strong></h6><br>
                        ...
                        <h6 style="margin-left:10px;margin-top:-5px"><strong>&nbsp;<u>Admission sur dossier</u></strong></h6><br>
