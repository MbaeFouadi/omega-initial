    ...
    <section class="main-wrapper">
        ...
        <h5 align="left" style="margin-top:-100px;margin-bottom:130px;margin-left:-50px;color:#00b185;"> Fin de préinscription : <?php echo $dat['date_fin'];?></h5>
                ...
                <div class="text-center mb-5">
                        ...
                        <h6>N° 23__________/UDC/<?php if($_SESSION['sg']==1){ echo "SG"; } else{  echo "SGA"; } ?>/SS</h6>
                        ...
                        <div class="row" style="text-align: justify;">
                            ...
                            <div class="col-md-10"><p style="font-size: 20px;"><?= utf8_encode($sqr1['nom'])?></p></div>
                        </div>
                        <div class="row">
                            <div class="col-md-2"><h5>Prenom:</h5></div>
                            <div class="col-md-10"><p style="font-size: 20px;"><?= utf8_encode($sqr1['prenom'])?></p></div>
                        </div>
                        <div class="row">
                       ...
                       <?php }
                       		...
                       		<p style="font-size: 20px;">A été inscrit(e) au titre de l’année universitaire :<?=$_SESSION['annee']?> </p>
                       <?php } ?>
