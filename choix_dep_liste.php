...
if($dat['concours']==1 and ($_SESSION['type']==1 || $_SESSION['type']==2 || $_SESSION['type']==4 || $_SESSION['type']==5 || $_SESSION['type']==6 || $_SESSION['type']==7

  )){
    if($_SESSION['dep']=="GI" || $_SESSION['dep']=="HE"){
        header('location:listeConcours/habitatGif.php');
    }
    if($_SESSION['dep']=="Com" || $_SESSION['dep']=="G1" || $_SESSION['dep']=="IE" || $_SESSION['dep']=="SF" || $_SESSION['dep']=="RE" || $_SESSION['dep']=="REp" || $_SESSION['dep']=="G2p" || $_SESSION['dep']=="REm" || $_SESSION['dep']=="G1m" || $_SESSION['dep']=="LLA" ){
    ...
    if($_SESSION['dep']=="STQ"){
        ...
        header('location:listeConcours/stat.php');
    }
    // if($_SESSION['dep']=="LLA"){
...
<div class="row">
    <div class="col-12">
        <form action="choix_dep_liste.php" method="POST">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="inputcomp1" class="form-control" name="faculte2">
                        ...
                        <?php 
                            if($_SESSION['type']==1 || $_SESSION['type']==2  || $_SESSION['type']==4 || $_SESSION['type']==5){
                                $pics = mysqli_query($link,"SELECT * FROM faculte ");
                                
                            }
                        while($data=mysqli_fetch_array($pics)){?>

                        <option value="<?php echo $data['code_facult'];?>" data-concour="<?php echo $data['concours'];?>"><?php echo utf8_encode($data['design_facult']);?></option>
