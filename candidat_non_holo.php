...
$req = mysqli_query($link,"SELECT holo.reference as reference,candidats.nin as nin ,nom,prenom,tel_mobile,traitant_recu,retenu FROM holo_candidat RIGHT JOIN holo on holo.reference=holo_candidat.references RIGHT JOIN candidats on candidats.reference_id=holo.id WHERE holo_candidat.references IS NULL order by candidats.nom DESC");
...
<body>
    ...
    <section class="main-wrapper">
       <aside class="left-aside">
        ...
        <h5 align="left" style="margin-top:-100px;margin-bottom:130px;margin-left:-60px;color:#00b185;"> Fin de préinscription : <?php echo $date['date_fin'];?></h5>
                </div>
            <div class="text-center mb-5">
				</div>
            <h2 align="center">Liste des candidats dont leurs transactions sont incorrectes</h2>
            <div class="row">
                <div class="col-12">
